...
1. Start from a provided corpus or manifest.
...
Start by reading `AGENTS.md`. The included scripts, transforms, proxy, and web app are starter assets for an agent to adapt to the user's corpus; they are not a complete production app.
